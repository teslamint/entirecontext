...
Collected research informing EntireContext roadmap and architecture decisions.
...
| Token Savings Experiment | [token-savings-experiment.md](token-savings-experiment.md) | 2026-08-19 | Protocol for measuring LLM token savings from context injection: injected-payload telemetry + transcript footprint over ON/OFF blocks |
| Token Savings Experiment — Handoff | [token-savings-experiment-handoff.md](token-savings-experiment-handoff.md) | 2026-08-20 | Current state, measured baseline (78 sessions, ~0.001% injection overhead), and step-by-step continuation plan for the next agent |
