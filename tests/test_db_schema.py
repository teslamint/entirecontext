...
class TestMigration:
    ...
    def test_migrate_v9_to_v10_adds_decision_outcomes(self):
        ...
        conn.execute(
            "CREATE TABLE decisions (id TEXT PRIMARY KEY, title TEXT, rationale TEXT, scope TEXT, staleness_status TEXT DEFAULT 'fresh', rejected_alternatives TEXT, supporting_evidence TEXT, created_at TEXT, updated_at TEXT)"
        )
        conn.execute(
